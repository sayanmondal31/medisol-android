...
import 'package:medisol/medicine_reminder/src/common/convert_time.dart';
import 'package:medisol/medicine_reminder/src/global_bloc.dart';
import 'package:medisol/medicine_reminder/src/models/errors.dart';
import 'package:medisol/medicine_reminder/src/models/medicine.dart';
import 'package:medisol/medicine_reminder/src/models/medicine_type.dart';
import 'package:medisol/medicine_reminder/src/ui/homepage/homepage.dart';
import 'package:medisol/medicine_reminder/src/ui/new_entry/new_entry_bloc.dart';
import 'package:medisol/medicine_reminder/src/ui/success_screen/success_screen.dart';
  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin.showDailyAtTime(
          ...
          'Medisol -- your medicine: ${medicine.medicineName}',
