...
import 'package:medisol/medicine_reminder/src/ui/medicine_details/medicine_details.dart';
    ...
    title: Row(
      children: <Widget>[
        GestureDetector(
          ...
          onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (context)=>MediPage()))
        ),
      ],
    ),
    elevation: 10.0,
